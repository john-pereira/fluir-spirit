            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-6 col-md-6">
                    <div class="cat-header-text small text-center">
                        <h1 class="fs-4 fw-600">Certification Courses</h1>
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Obcaecati veniam cum deserunt quasi debitis repellendus tempore blanditiis voluptates. Quod, nam impedit accusantium consequatur necessitatibus dolore iusto culpa ad rem facilis.</p>
