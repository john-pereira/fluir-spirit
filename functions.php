...
add_action('wp_enqueue_scripts', 'spirit_theme_files');
...
function custom_widgets() {
  ...
  register_sidebar( array(
		'name'          => 'Footer Sidebar',
		'id'            => 'footer_sidebar',
		'before_widget' => '<div class="col-lg3 col-md-3"><div class="footer_widget small">',
