            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6">
                    <div class="who-we-are-image">
                        <img class="image-fluid rounded" src="<?php echo the_field('who_we_are_image'); ?>" alt="Who We Are">
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="what-we-do-image">
                        <img class="image-fluid rounded" src="<?php echo the_field('what_we_do_image'); ?>" alt="What We Do">
                    </div>
                </div>
            </div>
        </div>
